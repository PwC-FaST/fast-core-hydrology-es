...
def handler(context, event):
    ...
    try:
        ...
        url, version = Helpers.parse_body(context,body)
        ...
        hydro_id_field = FunctionConfig.hydro_id_field
        normalized_hydro_properties = FunctionConfig.normalized_hydro_properties
        ...
        download_cmd = {
            ...
            "sourceID": source_id,
            "hydroIdField": hydro_id_field,
            "normalizedProperties": normalized_hydro_properties,
            "version": version}
...
class FunctionConfig(object):
    ...
    hydro_id_field = "PfafCuen"

    normalized_hydro_properties = dict([
        ('name',{'sourceProp': 'Nom_Rio'})])
